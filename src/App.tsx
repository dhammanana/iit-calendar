    ...
    >
      ...
      >
        ...
        >
          ...
          <NavButton active={activeTab === 'meditation'} onClick={() => handleTabClick('meditation')} icon={<ScreenIcon name="meditation" size={20} />} label={t('common.meditate') || t('common.stillness') || 'Meditate'} />
          <NavButton active={activeTab === 'chants'} onClick={() => handleTabClick('chants')} icon={<ScreenIcon name="chants" size={22} />} label={t('common.chant') || t('common.chants') || 'Chant'} />
          <NavButton active={activeTab === 'book'} onClick={() => handleTabClick('book')} icon={<ScreenIcon name="books" size={20} />} label={t('common.read') || t('common.books') || t('common.book') || 'Read'} />
